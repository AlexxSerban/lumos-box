  ...
  return (
    <footer id="footer" className="bg-background">
      <div className="grid grid-cols-1 lg:grid-cols-3">
        ...
        <div className="lg:col-span-1 bg-background text-foreground px-6 md:px-12 lg:px-16 py-16 md:py-20 border-r border-foreground/10">
          {/* Brand */}
          <div className="mb-6">
          ...
          <div className="mb-6">
            ...
            <a
              ...
              className="text-sm text-foreground/80 hover:text-foreground hover:underline hover:decoration-accent hover:decoration-1 hover:underline-offset-4 transition-all duration-200 block mb-2"
            >
              +40 7xx xxx xxx
            </a>
            <a
              href="mailto:hello@lumosbox.ro"
              className="text-sm text-foreground/80 hover:text-foreground hover:underline hover:decoration-accent hover:decoration-1 hover:underline-offset-4 transition-all duration-200 block"
            >
              hello@lumosbox.ro
            </a>
          </div>
          ...
          {/* Separator */}
          <Separator className="bg-foreground/20 h-px mb-6" />
          ...
          <nav className="flex flex-col space-y-2 mb-6">
            {navigationLinks.map((link, index) => (
              <a
                ...
                className="text-sm text-foreground/80 hover:text-foreground hover:underline hover:decoration-accent hover:decoration-1 hover:underline-offset-4 transition-all duration-200"
              >
                {link.label}
              </a>
            ))}
              ...
              <ul className="flex items-center gap-4 list-none p-0 m-0">
                <li>
                  <a
                    ...
                    className="focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-foreground focus-visible:ring-offset-2 rounded-sm transition-opacity hover:opacity-70"
                  >
                    <Instagram size={24} stroke="currentColor" className="text-foreground" />
                  </a>
                </li>
                <li>
                  <a
